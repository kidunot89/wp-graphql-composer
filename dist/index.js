(function (global, factory) {
  ...
  var compileClassName = function compileClassName(props) {
    ...
    _.each(classes, function (cN) {
      if (_typeof(cN) === 'object') {
        if (!!_.get(props, cN.name)) className = "".concat(className, " ").concat(cN.className);
      } else if (!!_.get(props, cN)) className = "".concat(className, " ").concat(cN);
    });
  ...
  */
  ...
  var ATTACHMENT_QUERY = apolloBoost.gql(_templateObject$1());
  var PAGE_QUERY = apolloBoost.gql(_templateObject2$1());
  var PAGE_BY_QUERY = apolloBoost.gql(_templateObject3());
  var POST_COMMENTS_QUERY = apolloBoost.gql(_templateObject4());
  ...
  var DELETE_COMMENT_MUTATION = apolloBoost.gql(_templateObject7());
  var NEW_COMMENT_MUTATION = apolloBoost.gql(_templateObject8());
  var UPDATE_COMMENT_MUTATION = apolloBoost.gql(_templateObject9());
      ...
      _createClass(PostStateManager, [{
        ...
        value: function render() {
          ...
          var newProps = _objectSpread({
            details: details,
            featured: featured
          }, _.omit(post, ['author', 'categories', 'featuredImage', 'tags', 'date', 'modified']), rest);
  ...
  var getTermName = function getTermName(term_slug, results) {
    ...
    var allTerms = _.get(results, "[0].meta.".concat(taxonomy));
  ...
  var archiveMapper = function archiveMapper(_ref3) {
    ...
    var rawResults = _.get(data, 'posts.nodes');
    var resultsData = _.map(rawResults, function (_ref4) {
  ...
  var EntryMeta = function EntryMeta(_ref) {
    ...
    return React__default.createElement("div", {
      ...
      __self: this
    }, "Posted On"), React__default.createElement("time", {
      className: "date",
      dateTime: date,
      __source: {
        fileName: _jsxFileName$g,
      ...
      __self: this
    }, moment(date).format('LLL')), modified !== date && React__default.createElement("time", {
      className: "modified",
      dateTime: modified,
      __source: {
        fileName: _jsxFileName$g,
      ...
      __self: this
    }, "Author"), React__default.createElement(reactRouterDom.Link, {
      key: author.id,
      ...
      __self: this
    }, "Categories"), _.map(categories, function (_ref2) {
      var id = _ref2.id,
          name = _ref2.name,
          slug = _ref2.slug;
      ...
      __self: this
    }, "Tags"), _.map(tags, function (_ref3) {
      var id = _ref3.id,
          name = _ref3.name,
          slug = _ref3.slug;
      return React__default.createElement(reactRouterDom.Link, {
  ...
  var postResult = function postResult(_ref4) {
    ...
    return React__default.createElement("article", Object.assign({
      ...
      __self: this
    }), featuredImage && React__default.createElement(reactRouterDom.Link, {
  ...
  var archive$1 = function archive(_ref) {
    ...
    var Results = function Results() {
      return React__default.createElement(React__default.Fragment, {
        ...
        return React__default.createElement(PostResult, Object.assign({}, r, {
          id: id,
          key: id
        }, _objectSpread({}, rest, {
  ...
  var MENU_QUERY = apolloBoost.gql(_templateObject$3());
  ...
  exports.compileClassName = compileClassName;
  ...
  exports.utilComposer = utilComposer;
