(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-client'), require('apollo-link'), require('apollo-cache-inmemory'), require('react-apollo'), require('uuid/v3'), require('react-html-parser'), require('react-router-dom'), require('lodash'), require('recompose'), require('apollo-boost'), require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'apollo-client', 'apollo-link', 'apollo-cache-inmemory', 'react-apollo', 'uuid/v3', 'react-html-parser', 'react-router-dom', 'lodash', 'recompose', 'apollo-boost', 'react'], factory) :
  (factory((global.WPGraphQLComposer = {}),global['apollo-client'],global['apollo-link'],global['apollo-cache-inmemory'],global['react-apollo'],global.v3,global['react-html-parser'],global['react-router-dom'],global._,global.recompose,global['apollo-boost'],global.React));
}(this, (function (exports,ApolloClient,apolloLink,apolloCacheInmemory,reactApollo,v3,ReactHtmlParser,reactRouterDom,_,recompose,apolloBoost,React) { 'use strict';
  ...
  var createClient = function createClient(httpLink, fragmentData) {
    ...
    if (fragmentData) {
      cache.fragmentMatcher = new apolloCacheInmemory.IntrospectionFragmentMatcher({
    ...
    return new ApolloClient({
      ...
      cache: new apolloCacheInmemory.InMemoryCache(cache),
      clientState: {}
    });
  };
  var WPProvider = function WPProvider(_ref) {
    ...
    return React__default.createElement(reactApollo.ApolloProvider, {
      client: client,
      __source: {
  ...
  var whileLoading = function whileLoading(_ref) {
    var view = _ref.view,
      ...
      return !!_.get(props, 'data.loading');
    } : _ref$cond;
    return recompose.branch(cond, recompose.renderComponent(view));
  };
  /**
  ...
  var errorHandler = function errorHandler(BaseComponent) {
      ...
      _createClass(ErrorHandler, [{
        ...
        value: function componentDidCatch(error, errorInfo) {
          this.setState({
            ...
            errorInfo: _.map(errorInfo, function (e) {
              return e.toString();
            })
          });
        }
    ...
    {
      return recompose.setDisplayName(recompose.wrapDisplayName(BaseComponent, 'errorHandler'))(ErrorHandler);
    }
  ...
  var forError = function forError(_ref2) {
    var view = _ref2.view,
      ...
      return !!_.get(props, errorProp) || !!_.get(props, 'error');
    } : _ref2$cond;
    return recompose.compose( // Catch errors below
    errorHandler, // Catch errors above
    recompose.branch(function (props) {
      return cond(props) && !props.fallback;
    }, recompose.renderComponent(recompose.compose(recompose.mapProps(function (props) {
      var type = errorType || 'system';
      var graphqlError = _.get(props, errorProp);
      ...
      var systemError = _.get(props, 'error');
    ...
    }))(view))), recompose.mapProps(function (_ref3) {
  ...
  var composeQuery = function composeQuery(queries) {
    return recompose.compose.apply(void 0, _toConsumableArray(_.map(queries, function (_ref4) {
      ...
      return recompose.branch(function (props) {
        return cond(props);
      }, reactApollo.graphql(query, config));
    })));
  };
  /**
   * 
  ...
  var baseComposer = function baseComposer(_ref5) {
    ...
    return function () {
      ...
      return recompose.compose(recompose.mapProps(mapper))(view);
    };
  };
  /**
  ...
  var standardComposer = function standardComposer(_ref7) {
    ...
    return function () {
      ...
      return recompose.compose.apply(void 0, [whileLoading(loading), forError(error)].concat(_toConsumableArray(extraHocs), [recompose.mapProps(function (props) {
  ...
  var queryComposer = function queryComposer(_ref9) {
    ...
    return function () {
      ...
      return recompose.compose.apply(void 0, [composeQuery(queries), whileLoading(loading), forError(error)].concat(_toConsumableArray(_.map(queries, function (_ref11) {
        ...
        return recompose.branch(function (props) {
          return cond(props);
        }, recompose.mapProps(mapper));
      })), _toConsumableArray(extraHocs), [recompose.mapProps(function (props) {
  ...
  */
  ...
  var defaultIcon = React__default.createElement(Icon, {
    name: "autorenew",
    size: "large",
    __source: {
  ...
  var progressMapper = (function (_ref) {
    ...
    var total = _.get(data, 'networkStatus') || _.get(data, 'loading');
  ...
  var error = function error(_ref) {
    ...
    return React__default.createElement("div", Object.assign({
      ...
      __self: this
    }, Array.isArray(message) ? React__default.createElement("ul", {
      __source: {
        fileName: _jsxFileName$5,
        lineNumber: 41
      },
      __self: this
    }, ___default.map(message, function (item, i) {
  ...
  var VIEWER_QUERY = apolloBoost.gql(_templateObject());
  var LOGIN_MUTATION = apolloBoost.gql(_templateObject2());
  ...
  var loginFormHandler = (function () {
    return function (BaseComponent) {
      ...
      function (_React$PureComponent) {
        ...
        _createClass(LoginFormHandler, [{
          ...
          value: function render() {
            ...
            var newProps = _objectSpread({}, _.omit(this.props, ['login', 'logout', 'mutate', 'loggedIn', 'data']), form, {
              onChange: onChange,
              onSubmit: onSubmit
            });

            return React__default.createElement(BaseFactory, Object.assign({}, newProps, {
              __source: {
      ...
      {
        return recompose.setDisplayName(recompose.wrapDisplayName(BaseComponent, 'loginFormHandler'))(LoginFormHandler);
      }
  ...
  var userStatusHandler = (function () {
    return function (BaseComponent) {
        ...
        _createClass(UserStatusHandler, [{
          ...
          value: function render() {
            var login = this.login,
                logout = this.logout;
            return BaseFactory(_objectSpread({}, _.omit(this.props, ['client']), this.state, {
              login: login,
              logout: logout
            }));
          }
      ...
      {
        return recompose.setDisplayName(recompose.wrapDisplayName(BaseComponent, 'userStatusHandler'))(UserStatusHandler);
      }
  ...
  var userControls$1 = function userControls(_ref) {
    ...
    return React__default.createElement("div", Object.assign({
      ...
      __self: this
    }, "Welcome back, ", ' ', " ", React__default.createElement("strong", {
      __source: {
        fileName: _jsxFileName$7,
        lineNumber: 31
      },
      __self: this
    }, nicename ? nicename : firstName), "!")), React__default.createElement("div", {
      className: "logout",
      __source: {
        fileName: _jsxFileName$7,
        lineNumber: 33
  ...
  userControls$1.compose = queryComposer({
    ...
    sharedMapper: function sharedMapper(_ref2) {
      ...
      var userId = _.get(data, 'viewer.userId');
      var nicename = _.get(data, 'viewer.nicename');
      var firstName = _.get(data, 'viewer.firstName');
      return _objectSpread({
        userId: userId,
        nicename: nicename,
        firstName: firstName
  ...
  var login$1 = function login(_ref) {
    ...
    return React__default.createElement("form", Object.assign({
      ...
      __self: this
    }), formError && React__default.createElement("legend", {
      ...
      __self: this
    }, formError), React__default.createElement("div", {
      ...
      __self: this
    }), userFieldError && React__default.createElement("small", {
      ...
      __self: this
    }, userFieldError)), React__default.createElement("div", {
      ...
      __self: this
    }), passFieldError && React__default.createElement("small", {
      className: "field-info",
      __source: {
        fileName: _jsxFileName$8,
        lineNumber: 60
      ...
      __self: this
    }, passFieldError)), React__default.createElement("button", {
  ...
  login$1.compose = function () {
    var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      return _.get(props, 'loggedIn');
    } : _ref2$loginCond;

    return recompose.compose(forError(error$$1), reactApollo.withApollo, userStatusHandler(), recompose.branch(function (props) {
      return loginCond(props);
    }, recompose.renderComponent(userControlsView)), reactApollo.graphql(LOGIN_MUTATION), loginFormHandler())(view);
  };
  /**
  ...
  var postPropsMapper = function postPropsMapper(post) {
    var featured = _.get(post, 'featuredImage.id');
    var details = {
      author: _.get(post, 'author'),
      categories: _.get(post, 'categories.nodes'),
      date: _.get(post, 'date'),
      modified: _.get(post, 'modified'),
      tags: _.get(post, 'tags.nodes')
    };
    return _objectSpread({
      details: details,
      featured: featured
    }, _.omit(post, ['author', 'categories', 'featuredImage', 'tags', 'date', 'modified']));
  };
  ...
  var getTermName = function getTermName(term_slug, results) {
    ...
    var allTerms = _.get(results, "[0].details.".concat(taxonomy));
    var term = _.find(allTerms, function (_ref) {
      var slug = _ref.slug;
  ...
  var archiveMapper = function archiveMapper(_ref3) {
    ...
    var resultsData = _.map(_.get(data, 'posts.nodes'), postPropsMapper);
  ...
  var CUSTOM_LOGO_QUERY = apolloBoost.gql(_templateObject$1());
  var ATTACHMENT_QUERY = apolloBoost.gql(_templateObject2$1());
  var PAGE_QUERY = apolloBoost.gql(_templateObject3());
  var PAGE_BY_QUERY = apolloBoost.gql(_templateObject4());
  var POST_QUERY = apolloBoost.gql(_templateObject5());
  var POST_BY_QUERY = apolloBoost.gql(_templateObject6());
  var ARCHIVE_QUERY = apolloBoost.gql(_templateObject7());
  ...
  var attachmentMapper = function attachmentMapper(_ref4) {
    ...
    if (sizes && sizes.length > 0) {
      ...
      return _objectSpread({
        ...
        srcSet: sources.join(', '),
        sizes: srcSizes.join(', ')
      }, _.omit(rest, ['fallback'].concat(variables)));
    }
  ...
  var customLogoMapper = function customLogoMapper(_ref5) {
    ...
    var imgSrc = _.get(data, 'themeMods.customLogo.sourceUrl') || src;
    var altText = alt || _.get(data, 'themeMods.customLogo.altText');
    var sizes = _.get(data, 'themeMods.customLogo.mediaDetails.sizes');
  ...
  var pageStateManager = function pageStateManager(BaseComponent) {
    ...
    {
      return recompose.setDisplayName(recompose.wrapDisplayName(BaseComponent, 'pageStateManager'))(PageStateManager);
    }
  ...
  var postStateManager = function postStateManager(BaseComponent) {
    ...
    function (_React$PureComponent2) {
      ...
      _createClass(PostStateManager, [{
        ...
        value: function render() {
          ...
          var post = _.get(data, 'post') || _.get(data, 'postBy');
    ...
    {
      return recompose.setDisplayName(recompose.wrapDisplayName(BaseComponent, 'postStateManager'))(PostStateManager);
    }
  ...
  var archive$1 = function archive(_ref) {
    ...
    var Results = function Results() {
      return React__default.createElement(React__default.Fragment, {
        ...
        __self: this
      }, header)), _.map(resultsData, function (_ref2) {
        var id = _ref2.id,
            r = _objectWithoutProperties(_ref2, ["id"]);

        return React__default.createElement(Result, Object.assign({}, r, {
          id: id,
          key: id
        }, rest, {
          __source: {
  ...
  var MENU_QUERY = apolloBoost.gql(_templateObject$2());
  var MENU_WHERE_QUERY = apolloBoost.gql(_templateObject2$2());
  var MENU_ITEM_QUERY = apolloBoost.gql(_templateObject3$1());
  ...
  var menuItem = function menuItem(_ref2) {
    ...
    return React__default.createElement(React__default.Fragment, {
      ...
      return React__default.createElement(Link, Object.assign({}, _objectSpread({}, rest, {
        url: url,
        homeUrl: homeUrl
      }), {
        __source: {
    ...
    }), !_.isEmpty(items) && React__default.createElement(SubMenu, Object.assign({
      items: items,
      SubMenu: SubMenu,
      MenuItem: MenuItem
    }, {
  ...
  menuItem.compose = queryComposer({
    ...
    sharedMapper: function sharedMapper(_ref6) {
      ...
      var items = _.get(data, 'menuItem.childItems.nodes');
      return _objectSpread({
        items: items
      }, _.omit(rest, 'id'));
    }
    ...
    _createClass(subMenu, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(React__default.Fragment, {
          ...
          __self: this
        })), React__default.createElement("ul", Object.assign({
          className: className
        }, rest, {
          __source: {
            fileName: _jsxFileName$e,
          ...
          return React__default.createElement("li", {
            ...
            __self: this
          }, React__default.createElement(MenuItem, Object.assign({
            id: id
          }, _objectSpread({}, r, {
            MenuItem: MenuItem,
            SubMenu: SubMenu
  ...
  var menuStateManager = function menuStateManager(BaseComponent) {
      ...
      _createClass(MenuStateManager, [{
        ...
        value: function render() {
          ...
          var newProps = _objectSpread({
            items: _.get(menu, 'menuItems.nodes')
          }, _.omit(menu, 'id', 'menuItems'), _.omit(rest, 'id'));
    ...
    {
      return recompose.setDisplayName(recompose.wrapDisplayName(BaseComponent, 'menuStateManager'))(MenuStateManager);
    }
  ...
  var menu = function menu(_ref) {
    ...
    return React__default.createElement(Element, Object.assign({
      ...
      __self: this
    }), !_.isEmpty(items) && _.map(items, function (_ref2) {
      var id = _ref2.id,
      ...
      return React__default.createElement("li", {
        ...
        __self: this
      }, React__default.createElement(MenuItem$$1, Object.assign({
        id: id
      }, _objectSpread({}, r, {
        SubMenu: SubMenu$$1,
        MenuItem: MenuItem$$1
  ...
  menu.compose = queryComposer({
    ...
    queries: [{
      ...
      mapper: function mapper(_ref6) {
        ...
        return _objectSpread({
          homeUrl: _.get(data, 'generalSettings.url'),
          menu: _.get(data, 'menus.nodes[0]')
        }, rest);
      }
    }, {
  ...
  var HEADER_QUERY = apolloBoost.gql(_templateObject$3());
  ...
  var router = function router(routesView) {
    return function (BaseComponent) {
      ...
      {
        return recompose.setDisplayName(recompose.wrapDisplayName(BaseComponent, 'routesProcessor'))(RoutesProcessor);
      }
  ...
  var LOOP_QUERY = apolloBoost.gql(_templateObject$4());
  ...
  exports.Loading = Loading;
  exports.progressMapper = progressMapper;
  exports.error = error;
  exports.Error = Error$1;
  exports.errorMapper = errorMapper;
  exports.Icon = Icon;
  exports.VIEWER_QUERY = VIEWER_QUERY;
  exports.LOGIN_MUTATION = LOGIN_MUTATION;
  exports.login = login$1;
  exports.Login = Login;
  exports.userControls = userControls$1;
  exports.UserControls = UserControls;
  exports.postPropsMapper = postPropsMapper;
  exports.archiveMapper = archiveMapper;
  exports.CUSTOM_LOGO_QUERY = CUSTOM_LOGO_QUERY;
  exports.ATTACHMENT_QUERY = ATTACHMENT_QUERY;
  exports.PAGE_QUERY = PAGE_QUERY;
  exports.PAGE_BY_QUERY = PAGE_BY_QUERY;
  ...
  exports.MENU_QUERY = MENU_QUERY;
  exports.MENU_WHERE_QUERY = MENU_WHERE_QUERY;
  exports.MENU_ITEM_QUERY = MENU_ITEM_QUERY;
  exports.menuInitialState = menuInitialState;
