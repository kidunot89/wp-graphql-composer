...
page.compose = queryComposer({
  ...
  queries: [{
    ...
    query: PAGE_BY_QUERY,
    config: { options: function options(_ref4) {
        var pageId = _ref4.pageId,
            uri = _ref4.uri;
        return { pageId: pageId, uri: uri };
      } }
  }, {
    ...
    query: PAGE_QUERY,
    config: { options: function options(_ref6) {
        var id = _ref6.id;
        return { id: id };
      } }
  }],
...
post.compose = queryComposer({
  ...
  queries: [{
    ...
    query: POST_BY_QUERY,
    config: { options: function options(_ref8) {
        var postId = _ref8.postId,
            uri = _ref8.uri,
            slug = _ref8.slug;
        return { postId: postId, uri: uri, slug: slug };
      } }
  }, {
    ...
    query: POST_QUERY,
    config: { options: function options(_ref10) {
        var id = _ref10.id;
        return { id: id };
      } }
  }],
