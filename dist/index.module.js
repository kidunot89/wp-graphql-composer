...
var mapLoopProps = function mapLoopProps(_ref) {
  ...
  var pageForPostsSlug = get(data, 'allSettings.readingSettingsPageForPosts');
  var pageOnFront = get(data, 'allSettings.readingSettingsPageOnFront');
  var structure = get(data, 'allSettings.permalinkSettingsStructure');
  var tagBase = get(data, 'allSettings.permalinkSettingsTagBase');
  var categoryBase = get(data, 'allSettings.permalinkSettingsCategoryBase');
